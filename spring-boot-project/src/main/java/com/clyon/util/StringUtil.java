...
public class StringUtil extends StringUtils {
	...
	if (null != str && !"".equals(str) && !"".equals(trimToEmpty(str))
	...
	if (strs != null && strs.length == 3) {
	    result[0] = new StringBuilder(strs[0]).append("|").append(strs[1])
		    .toString();
	    result[1] = strs[2];
	}
	return result;
    ...
    /**
     * @author zzj 获取图片的url，去掉签名的id
     *         568649|http://192.168.5.250:8080/group2/M00/06
